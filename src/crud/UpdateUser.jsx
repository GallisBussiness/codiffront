...
export const UpdateUser = () => {
  ...
  return (
    <div className="card w-5/12 mx-auto my-10 shadow-2xl bg-gradient-to-br from-white to-yellow-500 opacity-90  p-5 animate__animated animate__zoomIn animate__faster">
