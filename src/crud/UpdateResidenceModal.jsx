...
function UpdateResidenceModal({ isOpen, onResolve, onReject, residence }) {
  const [sessions, setSessions] = useState([]);
  const defaultValues = {
    _id: residence?._id,
    nom: residence?.nom,
    session: residence?.session?._id,
  };
...
export default create(UpdateResidenceModal);
