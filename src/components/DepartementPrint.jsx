...
export const DepartementPrint = forwardRef(
  ({ selectionnes, departement }, ref) => {
    return (
      <div ref={ref} className="bg-white my-10">
        ...
        <div className="flex items-center justify-center py-2 bg-green-400">
          ...
          >
            CODIFICATION PEDAGOGIQUE DU DEPARTEMENT : {departement}
          </Text>
        </div>
        <Divider />
        <div className="my-5">
          {selectionnes?.map((s, i) => (
            <div key={i}>
              <div className="text-center">
                <Text size={14} fw="bold" underline>
                  {s[0]}
                </Text>
              </div>
              <div className="my-2 mx-5">
                <Table striped withBorder withColumnBorders>
                  ...
                  <tbody>
                    {s[1]
                      .sort((a, b) =>
                        a.inscription.etudiant.sexe >
                        b.inscription.etudiant.sexe
                          ? 1
                          : a.inscription.etudiant.sexe ===
                            b.inscription.etudiant.sexe
                          ? 0
