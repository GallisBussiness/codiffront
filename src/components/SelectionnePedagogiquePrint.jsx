...
export const SelectionnePedagogiquePrint = forwardRef(
  ({ selectionnes }, ref) => {
    return (
      <div ref={ref} className="bg-white my-10">
        ...
        <div className="flex items-center justify-center py-2 bg-green-400">
          ...
          >
            CODIFICATION PEDAGOGIQUE
          </Text>
        </div>
        <Divider />
        <div className="my-5 mx-auto w-full text-center underline">
          {selectionnes?.length > 0 && (
            <Title order={4}>
              {selectionnes[0].inscription.formation.nom}{" "}
            </Title>
          )}
        </div>
